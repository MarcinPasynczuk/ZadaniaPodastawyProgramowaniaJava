...
//    private String customer;
    ...
    private String cutomerHowManyPeps;
    ...
    public Data(String customerNumber, String cutomerHowManyPeps, String cutomerCode, int month1, int month2, int month3, int month4, int month5, int month6, int month7, int month8, int month9, int month10, int month11, int month12) {

        this.customerNumber = customerNumber;
        this.cutomerHowManyPeps = cutomerHowManyPeps;
    ...
    public String getCutomerHowManyPeps() {
        return cutomerHowManyPeps;
    }

    public void setCutomerHowManyPeps(String cutomerHowManyPeps) {
        this.cutomerHowManyPeps = cutomerHowManyPeps;
    }
